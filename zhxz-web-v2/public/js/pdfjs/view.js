...
(function(modules) {
    ...
    var PDFViewerApplication = {
        ...
        load: function load(pdfDocument, scale) {
            ...
            var pageModePromise = pdfDocument.getPageMode().
            catch(function() {});
    ...
    function webViewerSidebarViewChanged(evt) {
        ...
        if (store && PDFViewerApplication.isInitialViewSet) {
            store.set('sidebarView', evt.view).
            catch(function() {})
        }
    }
    ...
    var PDFFindController = function() {
        ...
        },
        {
            ...
            value: function normalize(text) {
                return text.replace(this.normalizationRegex,
                function(ch) {
        ...
        },
        {
            ...
            value: function _prepareMatches(matchesWithLength, matches, matchesLength) {
                ...
                for (var i = 0,
                len = matchesWithLength.length; i < len; i++) {
        ...
        },
        {
            ...
            value: function extractText() {
                ...
                for (var i = 0,
                ii = this.pdfViewer.pagesCount; i < ii; i++) {
                    _loop(i, ii)
                }
            }
        },
    ...
    document.webL10n = function(window, document, undefined) {
        ...
        function substArguments(str, args, key) {
            var reArgs = /\{\{\s*(.+?)\s*\}\}/g;
            return str.replace(reArgs,
            function(matched_text, arg) {
                if (args && arg in args) {
                    return args[arg]
                }
                if (arg in gL10nData) {
    ...
    PDFHistory.prototype = {
        initialize: function pdfHistoryInitialize(fingerprint) {
            ...
            self.eventBus.on('presentationmodechanged',
            function(e) {
    ...
    var PDFOutlineViewer = function() {
        ...
        },
        {
            ...
            value: function _bindLink(element, item) {
                var _this = this;
                if (item.url) { (0, _pdfjsLib.addLinkAttributes)(element, {
                        url: item.url,
        ...
        },
        {
            ...
            value: function render(_ref2) {
                ...
                while (queue.length > 0) {
                    ...
                    for (var i = 0,
                    len = levelData.items.length; i < len; i++) {
    ...
    var PDFSidebar = function() {
        ...
        },
        {
            ...
            value: function _addEventListeners() {
                ...
                this.eventBus.on('outlineloaded',
                function(evt) {
                ...
                this.eventBus.on('attachmentsloaded',
                function(evt) {
    ...
    var PDFThumbnailViewer = function() {
        ...
        },
        {
            ...
            value: function scrollThumbnailIntoView(page) {
                ...
                if (numVisibleThumbs > 0) {
                    ...
                    if (page <= first || page >= last) { (0, _ui_utils.scrollIntoView)(thumbnail, {
        ...
        },
        {
            ...
            value: function _cancelRendering() {
                for (var i = 0,
                ii = this._thumbnails.length; i < ii; i++) {
    ...
    var PDFViewer = function() {
        ...
        },
        {
            ...
            value: function scrollPageIntoView(params) {
                ...
                if (scale === 'page-fit' && !dest[4]) { (0, _ui_utils.scrollIntoView)(pageView.div);
                    return
                }
    ...
    var SecondaryToolbar = function() {
        ...
        },
        {
            ...
            value: function _bindCursorToolsListener(buttons) {
                this.eventBus.on('cursortoolchanged',
                function(evt) {
            ...
            value: function renderMatches(matches) {
                ...
                for (var i = i0; i < i1; i++) {
                    ...
                    if (begin.divIdx === end.divIdx) {
                        ...
                        for (var n0 = begin.divIdx + 1,
                        n1 = end.divIdx; n0 < n1; n0++) {
    ...
    var Toolbar = function() {
        ...
        },
        {
            ...
            value: function _bindListeners() {
                ...
                items.scaleSelect.addEventListener('change',
                function() {
    ...
    var ViewHistory = function() {
        function ViewHistory(fingerprint) {
            ...
            this._initializedPromise = this._readFromStorage().then(function(databaseStr) {
                ...
                var index = void 0;
                for (var i = 0,
                length = database.files.length; i < length; i++) {
