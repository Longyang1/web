                    ...
                    <div class="float-e-margins">
                        <div id="center" :style="{'margin-top': layerid ? '20px' : ''}">
                            ...
                            <pagination
                                ...
                                <template v-if="!layerid && false" slot="opera">
                                    ...
                                    <table class="footable table table-stripped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center;width: 130px;">所属处室</th>
												...
												<th style="text-align:center;width: 160px;">毕业院校</th>
                                                <th style="text-align:center;width: 138px;">最高学历</th>
                                                <th style="text-align:center;width: 100px;">离职时间</th>
                                            </tr>
                                        </thead>
                                        <tbody id="meetingTbody" class="footable_table">
                                            <template v-for="(item, index) in page.list">
                                                <tr 
                                                    ...
                                                    <td v-if="!layerid" style="text-align:center;">{{ item.leaveTime | moment('YYYY-MM-DD') }}</td>
                                                </tr>
                                            </template>
                                        </tbody>
                                    </table>
