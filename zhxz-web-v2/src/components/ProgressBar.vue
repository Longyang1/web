...
<style>
  ...
  .slider .tips{position:absolute;left:-7px;bottom:30px;min-width:15px;text-align:center;padding:4px 8px;background: #477cff;border-radius:5px;height:24px;color:#fff}
