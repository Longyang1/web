        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12 user-main" :style="{height: height,'overflow-y': 'auto',padding: '10px'}">
            <pagination-simple 
                ...
                <template slot="searchBtnBefore">
                    <layui-inline>
                        <input  v-model='otherParam.dictName' class="layui-input" style="width: 300px" type="text" placeholder="输入名称">
                    </layui-inline>
                </template>
                <template slot="main">
                            ...
                            <table class="footable table table-stripped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="20px" style="text-align:center;">序号</th>
...
export default {
    ...
    methods: {
        ...
        handleSearchResult: function(data) {
            ...
            if (this.page.list) {
                this.page.list.forEach(element => {
                    if (this.checkedIds.indexOf(element.dictId) == -1) {
                        checkAll = false;
                        return;
                    }
                });
